const PERMISSIONS = [
    ...
    // Purchase Orders
    { tag: "purchaseorder:create", method: "POST", path: "/api/v1/purchase-orders", description: "Create a new purchase order", },
    { tag: "purchaseorder:read_all", method: "GET", path: "/api/v1/purchase-orders", description: "Get all purchase orders", },
    { tag: "purchaseorder:read_one", method: "GET", path: "/api/v1/purchase-orders/:id", description: "Get a single purchase order", },
    { tag: "purchaseorder:update_status", method: "PATCH", path: "/api/v1/purchase-orders/:id/receive-stock", description: "Mark a purchase order as received and update stock", },
];
