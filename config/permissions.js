const PERMISSIONS = [
    ...
    // Transactions
    {
        ...
        description: "Get All Transactions type= (Sales, Payments, etc.)",
    },

    // Analytics
    {
        tag: "analytics:read_sales_performance",
        method: "GET",
        path: "/api/v1/analytics/sales-performance",
        description: "Get Sales Performance Metrics",
    },
    {
        tag: "analytics:read_customer_insights",
        method: "GET",
        path: "/api/v1/analytics/customer-insights",
        description: "Get Customer Insights",
    },
    {
        tag: "analytics:read_product_performance",
        method: "GET",
        path: "/api/v1/analytics/product-performance",
        description: "Get Product Performance Analysis",
    },
    {
        tag: "analytics:read_payment_efficiency",
        method: "GET",
        path: "/api/v1/analytics/payment-efficiency",
        description: "Get Payment Collection Efficiency",
    },
    {
        tag: "analytics:read_inventory_turnover",
        method: "GET",
        path: "/api/v1/analytics/inventory-turnover",
        description: "Get Inventory Turnover Rate",
    },
    {
        tag: "analytics:read_sales_forecast",
        method: "GET",
        path: "/api/v1/analytics/sales-forecast",
        description: "Get Sales Forecast",
    },
    {
        tag: "analytics:read_customer_segments",
        method: "GET",
    ...
    // Purchase Orders
    {
        tag: "purchaseorder:create",
        method: "POST",
        path: "/api/v1/purchase-orders",
        description: "Create a new purchase order",
    },
    {
        tag: "purchaseorder:read_all",
        method: "GET",
        path: "/api/v1/purchase-orders",
        description: "Get all purchase orders",
    },
    {
        tag: "purchaseorder:read_one",
        method: "GET",
        path: "/api/v1/purchase-orders/:id",
        description: "Get a single purchase order",
    },
    {
        tag: "purchaseorder:update_status",
        method: "PATCH",
        path: "/api/v1/purchase-orders/:id/receive-stock",
