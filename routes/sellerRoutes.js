...
router.route('/')
    .get(authController.checkUserPermission('seller:read_all'), factory.getAll(Seller))
    .post(authController.checkUserPermission('seller:create'), factory.create(Seller));

router.route('/:id')
    .get(authController.checkUserPermission('seller:read_one'), factory.getOne(Seller))
    .patch(authController.checkUserPermission('seller:update'), factory.update(Seller))
    .delete(authController.checkUserPermission('seller:delete'), factory.delete(Seller));
