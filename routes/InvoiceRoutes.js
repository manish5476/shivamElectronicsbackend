...
router.get(
  "/:id/pdf",
  authController.checkUserPermission("invoice:generate_pdf"),
  invoiceController.generateInvoicePDF,
);

router.get(
  "/",
  authController.checkUserPermission("invoice:read_all"),
  factory.getAll(Invoice),
);
router.post(
  "/",
  authController.checkUserPermission("invoice:create"),
  invoiceController.findDuplicateInvoice,
  factory.create(Invoice),
);
router.get(
  "/:id",
  authController.checkUserPermission("invoice:read_one"),
  invoiceController.getInvoiceById,
);
router.patch(
  "/:id?",
  authController.checkUserPermission("invoice:update"),
  factory.update(Invoice),
);
router.delete(
  "/:id?",
  authController.checkUserPermission("invoice:delete"),
  factory.delete(Invoice),
);
router.post(
  "/productSales",
  authController.checkUserPermission("invoice:get_sales"),
  invoiceController.getProductSales,
);
