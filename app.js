...
const xss = require('xss'); // Assuming you want to use the xss library
const hpp = require('hpp');
const cors = require('cors');
const compression = require('compression');
const winston = require('winston'); // Assuming winston is used for logging
...
app.use('/api/v1/dashboard', require('./routes/dashboardRoutes')); // Ensure this route exists and has the /summary endpoint
